...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton.setGeometry(QtCore.QRect(190, 140, 401, 231))
    ...
    def show_popup(self):
        ...
        msg.setStandardButtons(QMessageBox.Retry|QMessageBox.Cancel|QMessageBox.Ignore)
        msg.setDefaultButton(QMessageBox.Ignore)

        msg.setInformativeText("infromation on the error")
